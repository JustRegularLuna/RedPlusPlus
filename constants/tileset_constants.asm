	const_def 1
; These tilesets share the first 160 tiles and the first 180 metatiles
...
; These are independent tilesets
	...
	const TILESET_PC_BATTLE_TOWER_OUTSIDE
	const TILESET_PC_JOHTO_OVERCAST
	const TILESET_PC_KANTO
	const TILESET_PC_INDIGO_PLATEAU
	...
	const TILESET_PC_POKECENTER
	const TILESET_PC_POKECOM_CENTER
