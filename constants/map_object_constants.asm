...
; see data/sprites/map_objects.asm
	...
	const SPRITEMOVEDATA_TILE_DOWN            ; 23
	const SPRITEMOVEDATA_TILE_UP              ; 24
	const SPRITEMOVEDATA_TILE_LEFT            ; 25
	const SPRITEMOVEDATA_TILE_RIGHT           ; 26
	const SPRITEMOVEDATA_OVERHEAD_TILE_DOWN   ; 27
...
; see data/sprites/facings.asm:Facings
	...
	const FACING_STEP_DOWN_FLIP  ; 23
	const FACING_STEP_UP_FLIP    ; 24
	const FACING_TILE_DOWN       ; 25
