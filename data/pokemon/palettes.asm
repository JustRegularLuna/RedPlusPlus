...
if DEF(NOIR)
	GRAYSCALE 23, 16, 24, 16 ; bulbasaur
	GRAYSCALE 23, 17, 24, 24 ; ivysaur
	GRAYSCALE 18, 14, 21, 23 ; venusaur
	GRAYSCALE 17, 10, 24, 19 ; charmander
	GRAYSCALE 14, 08, 23, 14 ; charmeleon
	GRAYSCALE 16, 09, 12, 10 ; charizard
	GRAYSCALE 18, 15, 18, 23 ; squirtle
	GRAYSCALE 18, 15, 18, 20 ; wartortle
	GRAYSCALE 19, 12, 17, 16 ; blastoise
	GRAYSCALE 17, 16, 23, 18 ; caterpie
	GRAYSCALE 23, 11, 21, 15 ; metapod
	GRAYSCALE 24, 12, 21, 12 ; butterfree
	GRAYSCALE 18, 11, 23, 15 ; weedle
	GRAYSCALE 23, 15, 23, 15 ; kakuna
	GRAYSCALE 21, 11, 18, 10 ; beedrill
	GRAYSCALE 26, 11, 27, 18 ; pidgey
	GRAYSCALE 17, 11, 18, 14 ; pidgeotto
	GRAYSCALE 17, 11, 23, 15 ; pidgeot
	GRAYSCALE 15, 08, 22, 17 ; rattata
	GRAYSCALE 23, 11, 23, 18 ; raticate
	GRAYSCALE 12, 16, 24, 15 ; spearow
	GRAYSCALE 13, 15, 15, 18 ; fearow
	GRAYSCALE 13, 07, 21, 10 ; ekans
	GRAYSCALE 12, 10, 18, 15 ; arbok
	GRAYSCALE 25, 11, 16, 10 ; pikachu
	GRAYSCALE 25, 16, 23, 14 ; raichu
	GRAYSCALE 18, 08, 15, 10 ; sandshrew
	GRAYSCALE 17, 08, 16, 10 ; sandslash
	GRAYSCALE 21, 09, 21, 12 ; nidoran_f
	GRAYSCALE 19, 11, 23, 12 ; nidorina
	GRAYSCALE 20, 15, 15, 18 ; nidoqueen
	GRAYSCALE 15, 08, 21, 11 ; nidoran_m
	GRAYSCALE 14, 08, 23, 12 ; nidorino
	GRAYSCALE 11, 07, 17, 12 ; nidoking
	GRAYSCALE 20, 08, 20, 13 ; clefairy
	GRAYSCALE 20, 08, 20, 13 ; clefable
	GRAYSCALE 17, 10, 23, 16 ; vulpix
	GRAYSCALE 28, 14, 24, 18 ; ninetales
	GRAYSCALE 20, 15, 23, 17 ; jigglypuff
	GRAYSCALE 20, 15, 23, 17 ; wigglytuff
	GRAYSCALE 15, 08, 20, 14 ; zubat
	GRAYSCALE 15, 08, 18, 11 ; golbat
	GRAYSCALE 17, 08, 25, 14 ; oddish
	GRAYSCALE 16, 09, 22, 15 ; gloom
	GRAYSCALE 13, 09, 24, 13 ; vileplume
	GRAYSCALE 20, 17, 17, 07 ; paras
	GRAYSCALE 15, 07, 21, 06 ; parasect
	GRAYSCALE 12, 05, 18, 09 ; venonat
	GRAYSCALE 17, 08, 17, 11 ; venomoth
	GRAYSCALE 13, 11, 13, 10 ; diglett
	GRAYSCALE 17, 10, 13, 10 ; dugtrio
	GRAYSCALE 27, 11, 18, 09 ; meowth
	GRAYSCALE 27, 09, 19, 09 ; persian
	GRAYSCALE 27, 15, 21, 12 ; psyduck
	GRAYSCALE 23, 12, 16, 15 ; golduck
	GRAYSCALE 22, 12, 20, 16 ; mankey
	GRAYSCALE 21, 10, 18, 15 ; primeape
	GRAYSCALE 20, 12, 19, 11 ; growlithe
	GRAYSCALE 24, 11, 18, 08 ; arcanine
	GRAYSCALE 13, 08, 14, 10 ; poliwag
	GRAYSCALE 13, 07, 15, 12 ; poliwhirl
	GRAYSCALE 17, 07, 20, 14 ; poliwrath
	GRAYSCALE 20, 09, 24, 13 ; abra
	GRAYSCALE 20, 09, 24, 13 ; kadabra
	GRAYSCALE 20, 09, 17, 10 ; alakazam
	GRAYSCALE 20, 12, 20, 11 ; machop
	GRAYSCALE 16, 07, 17, 08 ; machoke
	GRAYSCALE 19, 11, 20, 11 ; machamp
	GRAYSCALE 25, 15, 19, 14 ; bellsprout
	GRAYSCALE 23, 15, 24, 13 ; weepinbell
	GRAYSCALE 20, 17, 20, 15 ; victreebel
	GRAYSCALE 19, 14, 20, 15 ; tentacool
	GRAYSCALE 19, 09, 20, 13 ; tentacruel
	GRAYSCALE 17, 10, 24, 11 ; geodude
	GRAYSCALE 17, 10, 17, 09 ; graveler
	GRAYSCALE 16, 10, 18, 10 ; golem
	GRAYSCALE 24, 13, 20, 15 ; ponyta
	GRAYSCALE 24, 13, 20, 14 ; rapidash
	GRAYSCALE 17, 10, 16, 09 ; slowpoke
	GRAYSCALE 17, 15, 16, 16 ; slowbro
	GRAYSCALE 17, 13, 20, 11 ; magnemite
	GRAYSCALE 17, 13, 16, 13 ; magneton
	GRAYSCALE 15, 17, 16, 08 ; farfetch_d
	GRAYSCALE 15, 09, 22, 15 ; doduo
	GRAYSCALE 18, 11, 23, 15 ; dodrio
	GRAYSCALE 22, 15, 21, 13 ; seel
	GRAYSCALE 22, 11, 21, 13 ; dewgong
	GRAYSCALE 12, 06, 16, 10 ; grimer
	GRAYSCALE 12, 06, 17, 11 ; muk
	GRAYSCALE 11, 10, 18, 12 ; shellder
	GRAYSCALE 15, 07, 16, 09 ; cloyster
	GRAYSCALE 17, 08, 18, 07 ; gastly
	GRAYSCALE 12, 06, 11, 05 ; haunter
	GRAYSCALE 12, 05, 13, 14 ; gengar
	GRAYSCALE 16, 07, 21, 11 ; onix
	GRAYSCALE 23, 13, 18, 07 ; drowzee
	GRAYSCALE 24, 13, 17, 13 ; hypno
	GRAYSCALE 20, 12, 21, 15 ; krabby
	GRAYSCALE 20, 12, 20, 12 ; kingler
	GRAYSCALE 20, 11, 20, 07 ; voltorb
	GRAYSCALE 20, 11, 20, 07 ; electrode
	GRAYSCALE 20, 10, 22, 14 ; exeggcute
	GRAYSCALE 14, 12, 17, 16 ; exeggutor
	GRAYSCALE 18, 11, 22, 13 ; cubone
	GRAYSCALE 18, 11, 19, 12 ; marowak
	GRAYSCALE 15, 16, 18, 10 ; hitmonlee
	GRAYSCALE 17, 13, 16, 08 ; hitmonchan
	GRAYSCALE 17, 12, 21, 15 ; lickitung
	GRAYSCALE 16, 11, 19, 12 ; koffing
	GRAYSCALE 16, 08, 19, 12 ; weezing
	GRAYSCALE 13, 08, 17, 12 ; rhyhorn
	GRAYSCALE 13, 08, 21, 13 ; rhydon
	GRAYSCALE 20, 17, 25, 15 ; chansey
	GRAYSCALE 13, 09, 23, 09 ; tangela
	GRAYSCALE 14, 07, 16, 08 ; kangaskhan
	GRAYSCALE 26, 17, 19, 16 ; horsea
	GRAYSCALE 23, 16, 19, 09 ; seadra
	GRAYSCALE 18, 15, 20, 17 ; goldeen
	GRAYSCALE 22, 15, 24, 21 ; seaking
	GRAYSCALE 18, 13, 17, 13 ; staryu
	GRAYSCALE 21, 12, 15, 13 ; starmie
	GRAYSCALE 19, 14, 19, 16 ; mr__mime
	GRAYSCALE 20, 22, 19, 14 ; scyther
	GRAYSCALE 26, 14, 23, 18 ; jynx
	GRAYSCALE 28, 17, 17, 07 ; electabuzz
	GRAYSCALE 21, 12, 26, 18 ; magmar
	GRAYSCALE 19, 12, 21, 11 ; pinsir
	GRAYSCALE 17, 08, 26, 12 ; tauros
	GRAYSCALE 15, 08, 22, 14 ; magikarp
	GRAYSCALE 24, 14, 20, 15 ; gyarados
	GRAYSCALE 22, 15, 20, 15 ; lapras
	GRAYSCALE 17, 10, 21, 13 ; ditto
	GRAYSCALE 17, 10, 19, 13 ; eevee
	GRAYSCALE 21, 13, 24, 13 ; vaporeon
	GRAYSCALE 28, 15, 20, 14 ; jolteon
	GRAYSCALE 15, 09, 18, 11 ; flareon
	GRAYSCALE 13, 13, 09, 13 ; porygon
	GRAYSCALE 17, 13, 19, 11 ; omanyte
	GRAYSCALE 17, 13, 24, 12 ; omastar
	GRAYSCALE 14, 10, 23, 16 ; kabuto
	GRAYSCALE 14, 10, 19, 13 ; kabutops
	GRAYSCALE 19, 11, 14, 11 ; aerodactyl
	GRAYSCALE 20, 10, 22, 10 ; snorlax
	GRAYSCALE 19, 11, 24, 14 ; articuno
	GRAYSCALE 26, 16, 20, 12 ; zapdos
	GRAYSCALE 22, 17, 17, 07 ; moltres
	GRAYSCALE 24, 13, 20, 13 ; dratini
	GRAYSCALE 20, 12, 21, 18 ; dragonair
	GRAYSCALE 18, 11, 15, 24 ; dragonite
	GRAYSCALE 21, 10, 21, 08 ; mewtwo
	GRAYSCALE 22, 12, 23, 12 ; mew
	GRAYSCALE 21, 13, 24, 16 ; chikorita
	GRAYSCALE 23, 13, 21, 16 ; bayleef
	GRAYSCALE 18, 08, 21, 16 ; meganium
	GRAYSCALE 25, 14, 23, 09 ; cyndaquil
	GRAYSCALE 26, 15, 23, 09 ; quilava
	GRAYSCALE 26, 12, 23, 09 ; typhlosion
	GRAYSCALE 17, 14, 22, 13 ; totodile
	GRAYSCALE 17, 13, 18, 12 ; croconaw
	GRAYSCALE 15, 10, 14, 11 ; feraligatr
	GRAYSCALE 20, 13, 21, 15 ; zigzagoon
	GRAYSCALE 23, 13, 26, 15 ; linoone
	GRAYSCALE 15, 07, 20, 10 ; hoothoot
	GRAYSCALE 13, 07, 19, 13 ; noctowl
	GRAYSCALE 20, 12, 25, 19 ; ledyba
	GRAYSCALE 23, 12, 25, 19 ; ledian
	GRAYSCALE 22, 15, 20, 15 ; spinarak
	GRAYSCALE 15, 10, 11, 10 ; ariados
	GRAYSCALE 12, 08, 18, 11 ; crobat
	GRAYSCALE 22, 13, 24, 14 ; chinchou
	GRAYSCALE 24, 13, 24, 18 ; lanturn
	GRAYSCALE 15, 11, 20, 13 ; torkoal
	GRAYSCALE 25, 15, 25, 15 ; togepi
	GRAYSCALE 22, 13, 24, 14 ; togetic
	GRAYSCALE 19, 13, 26, 14 ; togekiss
	GRAYSCALE 18, 10, 26, 20 ; natu
	GRAYSCALE 18, 10, 22, 14 ; xatu
	GRAYSCALE 20, 08, 22, 08 ; mareep
	GRAYSCALE 19, 06, 22, 13 ; flaaffy
	GRAYSCALE 28, 12, 21, 11 ; ampharos
	GRAYSCALE 13, 13, 16, 14 ; bellossom
	GRAYSCALE 14, 13, 17, 14 ; marill
	GRAYSCALE 15, 11, 20, 11 ; azumarill
	GRAYSCALE 26, 15, 22, 14 ; politoed
	GRAYSCALE 17, 18, 22, 24 ; magnezone
	GRAYSCALE 17, 12, 23, 17 ; lickilicky
	GRAYSCALE 17, 11, 22, 10 ; hoppip
	GRAYSCALE 23, 14, 23, 08 ; skiploom
	GRAYSCALE 23, 10, 20, 17 ; jumpluff
	GRAYSCALE 25, 15, 28, 20 ; sunkern
	GRAYSCALE 21, 15, 28, 19 ; sunflora
	GRAYSCALE 19, 11, 19, 16 ; yanma
	GRAYSCALE 13, 14, 13, 15 ; yanmega
	GRAYSCALE 19, 11, 23, 22 ; wooper
	GRAYSCALE 20, 08, 22, 14 ; quagsire
	GRAYSCALE 19, 09, 19, 11 ; espeon
	GRAYSCALE 17, 06, 13, 06 ; umbreon
	GRAYSCALE 23, 08, 27, 10 ; murkrow
	GRAYSCALE 16, 12, 16, 13 ; honchkrow
	GRAYSCALE 20, 10, 19, 09 ; slowking
	GRAYSCALE 15, 10, 24, 13 ; misdreavus
	GRAYSCALE 15, 11, 23, 15 ; mismagius
	GRAYSCALE 19, 12, 14, 09 ; wobbuffet
	GRAYSCALE 23, 16, 20, 07 ; girafarig
	GRAYSCALE 21, 15, 28, 15 ; pineco
	GRAYSCALE 17, 08, 13, 08 ; forretress
	GRAYSCALE 13, 09, 17, 09 ; gligar
	GRAYSCALE 13, 14, 16, 21 ; gliscor
	GRAYSCALE 17, 10, 15, 10 ; steelix
	GRAYSCALE 18, 09, 20, 11 ; snubbull
	GRAYSCALE 16, 09, 19, 13 ; granbull
	GRAYSCALE 13, 08, 23, 07 ; scizor
	GRAYSCALE 10, 05, 15, 10 ; heracross
	GRAYSCALE 15, 07, 28, 16 ; sneasel
	GRAYSCALE 13, 07, 24, 16 ; weavile
	GRAYSCALE 15, 09, 24, 16 ; teddiursa
	GRAYSCALE 28, 12, 17, 09 ; ursaring
	GRAYSCALE 27, 11, 21, 11 ; slugma
	GRAYSCALE 13, 09, 13, 09 ; magcargo
	GRAYSCALE 17, 10, 18, 13 ; swinub
	GRAYSCALE 18, 11, 18, 12 ; piloswine
	GRAYSCALE 23, 14, 22, 12 ; mamoswine
	GRAYSCALE 19, 14, 22, 11 ; corsola
	GRAYSCALE 19, 10, 12, 09 ; remoraid
	GRAYSCALE 23, 13, 25, 17 ; octillery
	GRAYSCALE 20, 07, 27, 15 ; mantine
	GRAYSCALE 17, 10, 20, 10 ; skarmory
	GRAYSCALE 16, 08, 19, 09 ; houndour
	GRAYSCALE 16, 07, 19, 09 ; houndoom
	GRAYSCALE 24, 17, 18, 14 ; kingdra
	GRAYSCALE 20, 13, 24, 08 ; phanpy
	GRAYSCALE 19, 09, 21, 13 ; donphan
	GRAYSCALE 13, 14, 20, 11 ; porygon2
	GRAYSCALE 13, 14, 21, 12 ; porygon_z
	GRAYSCALE 16, 06, 18, 09 ; stantler
	GRAYSCALE 19, 11, 18, 12 ; hitmontop
	GRAYSCALE 17, 11, 24, 19 ; rhyperior
	GRAYSCALE 11, 13, 16, 13 ; tangrowth
	GRAYSCALE 28, 17, 17, 07 ; electivire
	GRAYSCALE 22, 12, 27, 18 ; magmortar
	GRAYSCALE 19, 07, 23, 16 ; miltank
	GRAYSCALE 17, 09, 20, 15 ; blissey
	GRAYSCALE 24, 13, 23, 17 ; leafeon
	GRAYSCALE 20, 11, 21, 11 ; glaceon
	GRAYSCALE 22, 16, 18, 22 ; sylveon
	GRAYSCALE 18, 13, 20, 13 ; larvitar
	GRAYSCALE 19, 09, 15, 09 ; pupitar
	GRAYSCALE 21, 13, 21, 10 ; tyranitar
	GRAYSCALE 21, 07, 25, 10 ; lugia
	GRAYSCALE 14, 11, 19, 14 ; ho_oh
	GRAYSCALE 21, 12, 20, 09 ; celebi
	GRAYSCALE 18, 10, 21, 18 ; latias
	GRAYSCALE 20, 13, 22, 15 ; latios
	GRAYSCALE 25, 16, 25, 13 ; egg

elif DEF(MONOCHROME)
rept 256
	MONOCHROME_RGB_TWO ; normal
	MONOCHROME_RGB_TWO ; shiny
endr

else
	RGB 30,22,17, 16,14,19 ; 000 normal
...
INCLUDE "gfx/pokemon/latias/normal.pal"
INCLUDE "gfx/pokemon/latias/shiny.pal"
INCLUDE "gfx/pokemon/latios/normal.pal"
INCLUDE "gfx/pokemon/latios/shiny.pal"
INCLUDE "gfx/pokemon/egg/normal.pal"
INCLUDE "gfx/pokemon/egg/shiny.pal"
	RGB 30,22,17, 16,14,19 ; 255 normal
	RGB 30,22,17, 16,14,19 ; 255 shiny
