...
TileCollisionTable::
	...
	NONTALKABLE  LANDTILE ; COLL_CAVE_LEFT
	...
	NONTALKABLE  LANDTILE ; STAIRS_RIGHT_DOWN
	NONTALKABLE  LANDTILE ; STAIRS_LEFT_DOWN
	NONTALKABLE  LANDTILE ; STAIRS_RIGHT_UP
	NONTALKABLE  LANDTILE ; STAIRS_LEFT_UP
