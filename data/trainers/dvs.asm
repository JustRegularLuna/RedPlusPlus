...
TrainerClassDVsAndPersonality: ; 270d6
	...
	db 252, PERFECT_DVS,   ABILITY_1 | QUIRKY, MALE   ; SONY1
	...
	db 252, PERFECT_DVS,   ABILITY_1 | QUIRKY, MALE   ; SONY2
	...
	db  88, $BB, $BB, $BB, ABILITY_1 | QUIRKY, FEMALE ; JESSIE
	db  88, $BB, $BB, $BB, ABILITY_1 | QUIRKY, MALE   ; JAMES
