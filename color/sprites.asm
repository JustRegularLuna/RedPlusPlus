...
SPR_PAL_GREEN	EQU 2
SPR_PAL_BROWN	EQU 3
SPR_PAL_PINK	EQU 4 ; TODO: make this one purple and use it
SPR_PAL_RANDOM	EQU 5 ; silver in the palette
SPR_PAL_TREE	EQU 6
SPR_PAL_ROCK	EQU 7
...
.noCarry
	...
	; If it's SPR_PAL_RANDOM, that means no particular palette is assigned
	cp SPR_PAL_RANDOM
	jr nz,.norandomColor

	; This is a (somewhat) random but consistent color
	; (cannot be SPR_PAL_PINK)
	ld a,[hSpriteOffset2]
	swap a
	and 3
