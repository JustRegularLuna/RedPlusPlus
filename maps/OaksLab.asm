OaksLab_MapScriptHeader:
	...
	object_event  6,  3, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, PERSONTYPE_SCRIPT, 0, CharmanderPokeballScript, EVENT_HIDE_OAKSLAB_STARTER_1
	object_event  7,  3, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, PERSONTYPE_SCRIPT, 0, SquirtlePokeballScript, EVENT_HIDE_OAKSLAB_STARTER_2
	object_event  8,  3, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, PERSONTYPE_SCRIPT, 0, BulbasaurPokeballScript, EVENT_HIDE_OAKSLAB_STARTER_3
