...
if DEF(NOIR)
; Pichu
	GRAYSCALE 13, 24, 15, 07
	GRAYSCALE 13, 15, 15, 31
	GRAYSCALE 13, 00, 31, 31
; Sentret
	GRAYSCALE 31, 17, 21, 07
	GRAYSCALE 31, 21, 21, 00
	GRAYSCALE 31, 31, 31, 00
; Ditto
	GRAYSCALE 31, 17, 22, 07
	GRAYSCALE 13, 22, 22, 31
	GRAYSCALE 13, 00, 31, 31
; Togepi
	GRAYSCALE 31, 25, 19, 07
	GRAYSCALE 16, 19, 19, 31
	GRAYSCALE 16, 31, 31, 31
; Smoochum
	GRAYSCALE 31, 25, 15, 07
	GRAYSCALE 12, 09, 15, 31
	GRAYSCALE 12, 00, 31, 31
; Munchlax
	GRAYSCALE 31, 14, 27, 07
	GRAYSCALE 14, 27, 27, 31
	GRAYSCALE 14, 00, 31, 31
; Elekid
	GRAYSCALE 31, 28, 22, 07
	GRAYSCALE 12, 22, 22, 00
	GRAYSCALE 12, 31, 31, 31
; Bellossom
	GRAYSCALE 28, 16, 20, 07
	GRAYSCALE 25, 20, 20, 00
	GRAYSCALE 25, 12, 12, 00
...
; Sentret
	...
	RGB 31,31,31, 31,19,09, 31,19,09, 00,00,00
...
; Togepi
	...
	RGB 04,19,31, 31,11,27, 31,11,27, 31,31,31
	RGB 04,19,31, 31,31,31, 31,31,31, 31,31,31
; Smoochum
	RGB 31,31,31, 31,27,00, 26,06,31, 07,07,07
	RGB 03,13,31, 20,00,24, 26,06,31, 31,31,31
	RGB 03,13,31, 00,00,00, 31,31,31, 31,31,31
; Munchlax
	RGB 31,31,31, 08,17,17, 30,28,16, 07,07,07
	RGB 16,15,08, 30,28,16, 30,28,16, 31,31,31
	RGB 16,15,08, 00,00,00, 31,31,31, 31,31,31
; Elekid
	RGB 31,31,31, 31,31,05, 17,23,31, 07,07,07
	RGB 29,05,05, 17,23,31, 17,23,31, 00,00,00
	RGB 29,05,05, 31,31,31, 31,31,31, 31,31,31
; Bellossom
	RGB 30,30,10, 29,08,27, 15,24,12, 07,07,07
	RGB 27,27,12, 15,24,12, 15,24,12, 00,00,00
	RGB 27,27,12, 09,15,07, 09,15,07, 00,00,00
endc
; 109bca
