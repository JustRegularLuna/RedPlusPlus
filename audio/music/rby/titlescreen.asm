Music_RBYTitleScreen:
	musicheader 4, 1, Music_RBYTitleScreen_Ch1
	musicheader 1, 2, Music_RBYTitleScreen_Ch2
	musicheader 1, 3, Music_RBYTitleScreen_Ch3
	musicheader 1, 4, Music_RBYTitleScreen_Ch4
