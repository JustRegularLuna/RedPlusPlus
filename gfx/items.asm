...
TownMapIcon:      INCBIN "gfx/items/town_map.2bpp.lz"
LiftKeyIcon:      INCBIN "gfx/items/lift_key.2bpp.lz"
CardKeyIcon:      INCBIN "gfx/items/card_key.2bpp.lz"
SecretKeyIcon:    INCBIN "gfx/items/secret_key.2bpp.lz"
SSTicketIcon:     INCBIN "gfx/items/s_s_ticket.2bpp.lz"
BikeVoucherIcon:  INCBIN "gfx/items/bike_voucher.2bpp.lz"
PokeFluteIcon:    INCBIN "gfx/items/pokeflute.2bpp.lz"
GoldTeethIcon:    INCBIN "gfx/items/gold_teeth.2bpp.lz"
...
EonTicketIcon:    INCBIN "gfx/items/eon_ticket.2bpp.lz"
...
SilphScopeIcon:   INCBIN "gfx/items/silphscope.2bpp.lz"
ApricornBoxIcon:  INCBIN "gfx/items/apricorn_box.2bpp.lz"
VsSeekerIcon:     INCBIN "gfx/items/vs_seeker.2bpp.lz"
