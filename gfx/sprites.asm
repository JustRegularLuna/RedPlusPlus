...
LeafBikeSpriteGFX::           INCBIN "gfx/sprites/leaf_bike.2bpp"
SurfingLapras::
RedSurfSpriteGFX::
LeafSurfSpriteGFX::           INCBIN "gfx/sprites/surf_lapras.2bpp"
...
BenchSitterSprite::    INCBIN "gfx/sprites/bench_sitter.2bpp"
...
PearlMeteoriteLodestoneSpriteGFX:: INCBIN "gfx/sprites/pearl_meteorite_lodestone.2bpp"
CableCarSilphSpriteGFX::           INCBIN "gfx/sprites/cable_car_silph.2bpp"
